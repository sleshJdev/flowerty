...
public class ContactController {
    ...
    @Autowired
    private RepositorySolrContactService repositoryContactService;
  // private UserService userService;
	...
	List<ContactDocument> list = repositoryContactService.findByNameContains("est"); //.findByNameContains("est", new PageRequest(0,10));
...
//	}});
	...
	repositoryContactService.add(contact);
	return contact;
    }
}
